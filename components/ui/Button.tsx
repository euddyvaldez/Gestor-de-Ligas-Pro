...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const variantStyles = {
    ...
    warning: 'bg-yellow-500 hover:bg-yellow-600 text-black focus:ring-yellow-400', // Ensured text-black for yellow
    info: 'bg-sky-500 hover:bg-sky-600 text-white focus:ring-sky-400',
    light: 'bg-gray-200 hover:bg-gray-300 text-gray-800 focus:ring-gray-300 border border-gray-300',
    dark: 'bg-gray-800 hover:bg-gray-900 text-white focus:ring-gray-700',
    link: 'text-blue-500 hover:text-blue-600 hover:underline focus:ring-blue-400 bg-transparent border-transparent',
